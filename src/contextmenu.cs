...
public class FilezooContextMenu : Menu {
  ...
  public static List<string> archiveSuffixes = new List<string>() {"bz2", "gz", "rar", "tar", "zip", "tgz"};
  ...
  public static List<string> videoSuffixes = new List<string>() {"mp4", "mkv", "ogv", "ogm", "divx", "gif", "avi", "mov", "mpg", "wmv", "mpeg", "flv"};
